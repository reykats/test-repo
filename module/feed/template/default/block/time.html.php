...
<div id="timeline_dates">
	<ul>
		<li class="parent active"><a href="#" onclick="$.ajaxCall('feed.viewMore', '{if defined('PHPFOX_IS_USER_PROFILE') && isset($aUser.user_id)}&profile_user_id={$aUser.user_id}{/if}{if isset($aFeedCallback.module)}&callback_module_id={$aFeedCallback.module}&callback_item_id={$aFeedCallback.item_id}{/if}&resettimeline=1', 'GET'); return false;" class="no_ajax_link">{phrase var='feed.now'}</a></li>
