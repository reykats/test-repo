...
<form method="post" enctype="multipart/form-data" action="{url link='admincp.gettingStarted.addtodolist'}"  id="core_js_blog_form">
    <div class="table_header" >
    {phrase var='gettingstarted.add_a_new_todo_list'}
</div>
<div class="table">
    ...
    <div class="table_right">
        <input type="text" name="val[title]" size="50" >{$aScheduledMail.title}</input>
    </div>
    <div class="clear"></div>
</div>
<div class="table">
...
<div class="table_clear">
    <input type="submit" id="submit_addarticlecategory"name="submit_addtodolist" value="{phrase var='core.submit'}" class="button" />
</div>
</form>