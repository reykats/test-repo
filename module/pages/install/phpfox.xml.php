<module>
	...
	<blocks>
		...
		<block type_id="0" m_connection="pages.view" module_id="pages" component="admin" location="3" is_active="1" ordering="5" disallow_access="" can_move="1">
