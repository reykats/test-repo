 ...
 * @version 		$Id: like.class.php 4412 2012-06-28 10:41:40Z Raymond_Benc $
 */
class Like_Service_Like extends Phpfox_Service 
{
	...
	public function getLikesForFeed($sType, $iItemId, $bIsLiked = false, $iLimit = 4, $bLoadCount = false)
	{
		...
		{
			$this->database()->where('l.type_id = \'' . $this->database()->escape($sType) . '\' AND l.item_id = ' . (int) $iItemId . ' AND l.user_id != ' . Phpfox::getUserId());
		}
