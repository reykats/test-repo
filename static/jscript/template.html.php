								...
								<div id="header_menu_space">
									<div id="header_sub_menu_search">
										<form method="post" id='header_search_form' action="{url link='recipe'}">
											...
											<input type="text" name="search[keyword]" value="{phrase var='core.search_dot'}" id="header_sub_menu_search_input" autocomplete="off" class="js_temp_friend_search_input" />										
										...
										<div><p><input type="radio"  name="search"id="searchByRecipe" value="recipe" checked style="height: 4px; width: 5px; margin-left: 229px;" />Recipes
											<input type="radio" name="search"id="searchBypage" value="pages/view_/"style="height: 4px; width: 5px; margin-left: 256px;"/>Pages</p>		</div>
									</div>
								</div>
							</div>	
							{/if}													
