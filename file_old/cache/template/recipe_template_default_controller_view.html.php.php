...
<div class="recipe-preparations">
	<span>Servings:</span> <?php echo $this->_aVars['aRecipe']['servings']; ?>&nbsp;&nbsp;&nbsp;&nbsp;<span>Prep Time:</span> <?php echo $this->_aVars['aRecipe']['prep_time']; ?>m&nbsp;&nbsp;&nbsp;&nbsp;<span>Cook Time:</span> <?php echo $this->_aVars['aRecipe']['cook_time']; ?>m&nbsp;&nbsp;&nbsp;&nbsp;<span>Ready In:</span> <?php echo $this->_aVars['aRecipe']['ready_in']; ?>
</div>
<div class="recipe-contents">
	<div class="recipe-desc">
		<div class="long_description">
<?php if (! empty ( $this->_aVars['aRecipe']['image_path'] )): ?>
			<div class="recipe-image">
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('thickbox' => true,'path' => 'recipe.url_image','file' => $this->_aVars['aRecipe']['image_path'],'suffix' => $this->_aVars['sSuffix'],'max_width' => '180','max_height' => '180','title' => $this->_aVars['aRecipe']['title'])); ?>
			</div>
<?php endif; ?>
...
<?php echo $this->_aVars['profileImage']; ?>
