...
<?php /* Cached: April 27, 2013, 5:28 am */ ?>
<?php 
/**
 * [PHPFOX_HEADER]
 * 
...
<?php endif; ?>
<?php endif; ?>
<?php if (! defined ( 'PHPFOX_IS_USER_PROFILE' ) && ! PHPFOX_IS_AJAX): ?>
...
<?php else: ?>
<?php /* Cached: April 27, 2013, 5:28 am */  if (isset ( $this->_aVars['bIsViewingComments'] ) && $this->_aVars['bIsViewingComments']): ?>
...
<?php /* Cached: April 27, 2013, 5:28 am */  if (Phpfox ::getParam('like.show_user_photos')): ?>
