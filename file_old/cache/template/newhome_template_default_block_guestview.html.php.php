...
<?php /* Cached: April 27, 2013, 5:18 am */ ?>
<?php 
/**
 * [PHPFOX_HEADER]
 * 
...
<?php endif; ?>
		<div id="content_hp">
<div class="bg_home_style">
	<div class="bg_header_cnt">Sign in to Everyday Oils!</div>
...
<?php (($sPlugin = Phpfox_Plugin::get('user.template_controller_login_end')) ? eval($sPlugin) : false); ?>
			...
			<div class="table_clear">
				...
				Not Yet A Member? <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl("user.register"); ?>">Join Everyday Oils</a>
...
<h1 class="home_page_header">HOME</h1>
</div>
