...
<?php if (isset ( $this->_aVars['aBirthdays'] ) && is_array ( $this->_aVars['aBirthdays'] ) && count ( $this->_aVars['aBirthdays'] )): ?>
<?php if (! $this->_aVars['bIsEventSection']): ?>
<div class="block_headline"><?php echo Phpfox::getPhrase('friend.birthdays'); ?></div>
<?php endif; ?>
<?php if (count((array)$this->_aVars['aBirthdays'])):  $this->_aPhpfoxVars['iteration']['birthdays'] = 0;  foreach ((array) $this->_aVars['aBirthdays'] as $this->_aVars['sDaysLeft'] => $this->_aVars['aBirthDatas']):  $this->_aPhpfoxVars['iteration']['birthdays']++; ?>
