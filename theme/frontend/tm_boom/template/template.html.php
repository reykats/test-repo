 ...
 * @author			Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: template.html.php 3370 2011-10-28 16:55:29Z Raymond_Benc $
 */
				...
				<div {is_page_view} class="holder">	
					<div id="content_holder">		
						...
						{if Phpfox::getLib('module')->getfullControllerName()=='core.index-visitor'}
							{template file='core.block.home-features'}
						{/if}
						...
						<div id="main_content">
							...
							<div id="main_content_padding">
								...
								<div id="content_load_data">
									...
									<h1><a href="{$aBreadCrumbTitle[1]}">{$aBreadCrumbTitle[0]|clean|split:60}</a></h1>
									{/if}
