	...
	<body>
		...
		<div id="header">			
			...
			<ul class="left_menu">
				...
				<li><a href="http://everyday-oils.com/network/event/">Members</a></li>
							...
							<div id="header_search">	
								<div id="header_menu_space">
									<div id="header_sub_menu_search">
										...
										<!--<form method="post"style="display:none;" id='header_search_form1' action="{url link ='pages/view_/'}"onbeforesubmit="$Core.Search.checkDefaultValue(this,'Search Pages...');">
									 	
											<input type="hidden" value="search[search]" name="core[security_token]" />
											<input type="text" name="search[{$aSearchTool.search.name}]" value="" id="header_sub_menu_search_input" autocomplete="off"placeholder="Search Pages..." class="js_temp_friend_search_input" />										
											<div id="header_sub_menu_search_input"></div>
										...
										<div style="float:left;">
											...
											<input type="radio" name="search" id="searchBypage"  value="pages/view_/"/><label>Pages</label></p>		
										</div>
									</div>
								</div>
							</div>	
